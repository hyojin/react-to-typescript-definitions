...
export declare function generateWithMetadataFromSource(moduleName: string | null, code: string, options?: IOptions, reactImport?: string): {
    kind: string;
    name: string;
    emitted: string;
}[];
export declare function generateWithMetadataFromAst(moduleName: string | null, ast: any, options?: IOptions, reactImport?: string): {
    kind: string;
    name: string;
    emitted: string;
}[];
